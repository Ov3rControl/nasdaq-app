  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden splash-vt">
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 right-1/3 w-16 h-16 bg-secondary retro-border rotate-45 animate-pulse delay-500" />
      ...
      >
        ...
        <div className="flex space-x-4 justify-center">
          ...
          <div className="w-6 h-6 bg-accent retro-border animate-bounce delay-100" />
